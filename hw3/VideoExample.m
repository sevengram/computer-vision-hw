...
disparityRange = [0, 64];
%disparityMap = disparity(frameLeftGray, frameRightGray, 'DisparityRange', disparityRange);
disparityMap = ssd_disparity(frameLeftGray, frameRightGray, 3, disparityRange);
figure;
